            ...
            <?php endif; ?>
                            ...
                            ?>
                                        ...
                                        <table class="form-table">
                                            ...
                                            <tr valign="top"><th scope="row"><?php _e('Icon', 'fcpt') ?></th><td><?php echo $this->custom_select(array('name' => 'menu_icon', 'style'=> 'width:240px'), $this->get_icons(), $custom_post_type['menu_icon'], false); ?> <span path="<?php echo WP_PLUGIN_URL . '/' . $this->_plugin_basename . '/icons'; ?>" style="display:block; float:right;width:16px; height:16px; margin-top:5px; background-position:left top; background-repeat:no-repeat; background-image:url(<?php echo WP_PLUGIN_URL . '/' . $this->_plugin_basename . '/icons/' . (isset($custom_post_type['menu_icon']) ? $custom_post_type['menu_icon'] : 'default.png'); ?>)"></span></td></tr>
